      ...
      <div>
        ...
        <div className={styles.selectBar}>
          <div className={styles.choiceAndCreate}>
            <div className={styles.newContentText}>나에게 맞는 식물을 검색해보세요!</div>
            <div className={styles.selectAndBtn}>
              <select className={styles.selectBox} onChange={state.onChangeLevel}>
                <option value='none'>난이도 검색</option>
                <option value='easy'>초보자</option>
                <option value='normal'>경험자</option>
                <option value='hard'>숙련자</option>
              </select>
              <select className={styles.selectBox} onChange={state.onChangeSeason}>
          ...
          <div className={styles.choiceAndCreate}>
            <div className={styles.newContentText}>새로운 글을 등록하고 싶으신가요?</div>
